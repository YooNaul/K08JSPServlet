...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
//get방식으로 전송된 폼값을 날짜형식을통해 타임스템프로 변경한다.
SimpleDateFormat s = new SimpleDateFormat("yyyy-MM-dd HH:mm");
long add_date = s.parse(request.getParameter("add_date")).getTime();
//숫자형식을 전송된 값을 정수로 변경한다.
...
파일다운로드 구현시 사용하는 설정
	...
	jpg와 같이 이미지 파일은 웹브라우저가 인식하는 MIME타입이므로 다운로드를
...
<body>
	...
	/*
	첫번째 출력결과에서는 myNumber라는 헤더명이 2번 출력되는디,
