...
<!--  
Tomcat8.0부터는 EL에서 변수할당을 할수 있다. 하지만 변수 할당과 동시에
...
num3 div num4 : ${num3 div num4 } <!-- 나눗셈에는 div 연산자를 쓸수있다. --> <br />
num3 % num4 : ${num3 % num4 } <br />
num3 mod num4 : ${num3 mod num4 } <!-- 나머지 연산에는 mod 연산자를 쓸수있다. -->

<!-- EL에서는 +는 덧셈연산만 가능하고, 문자열의 연결에는 사용되지 않는다. -->
<h3>+ 연산자는 덧셈만 가능</h3>
num1 + "34" : ${num1 + "34" } <br /><!-- 문자열형태의 숫자는 자동변환되어 연산됨 -->
num2 + "이십" : \${num2 + "이십" } <br /><!-- 숫자와 문자열은 연산불능 -->
"삼십" + "사십" : \${"삽십" + "사십" } <!-- 문자열과 문자열도 연산불능 -->
