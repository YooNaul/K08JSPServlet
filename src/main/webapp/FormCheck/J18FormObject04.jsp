...
<head>
    ...
    <script>
        ...
        var isValidate = function(frm){
            ...
            */
            var isGender = false;
            //라디오의 개수만큼 반복한다. DOM을 통해 개수를 알수있다.
            ...
            */
            ...
            /*
            textarea는 자체적인 value속성은 없으나, JS에서 DOM객체를 통함
        ...
        function idCheck(fn){
            ...
            if(fn.id.value==""){
                ...
                */
                ...
                이떄 파라미터명은 id이고 전달되는 값은 입력된 아이디이다.
                */
                window.open("./id_overapping.jsp?id="+fn.id.value,
                    "idover", "width=600,heoght=300");
            }
        }
    </script>
</head>
